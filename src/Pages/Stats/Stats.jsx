...
const Stats = () => {
  ...
  return (
    <div className="my-9 px-4 md:px-0 container mx-auto bg-[#F8FAFC]">
      ...
      <h1 className="text-[#1F2937] font-bold text-3xl">Friendship Analytics </h1>

      {/* History */}
      <div className="shadow-lg rounded-2xl bg-white my-4 p-5">
        ...
        <div className="flex items-center justify-center pt-4 pb-10">
          ...
          >
            ...
            />
            <Tooltip></Tooltip>
            <Legend iconType="circle" className="mt-6"></Legend>
          </PieChart>
        </div>
      </div>
    </div>
